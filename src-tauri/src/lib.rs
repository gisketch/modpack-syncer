...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::packs::create_local_pack,
            ...
            commands::prism_control::set_instance_artifact_disabled,
            commands::prism_control::get_instance_minecraft_dir,
            commands::prism_control::delete_prism_instance,
            ...
            commands::modrinth::list_modrinth_version_dependencies,
            ...
            commands::publish::set_manifest_mod_optional,
            commands::publish::load_source_manifest,
            commands::publish::restore_manifest_from_source,
            commands::publish::set_manifest_artifact_optional,
            commands::publish::delete_manifest_artifact,
            commands::publish::restore_manifest_artifact,
