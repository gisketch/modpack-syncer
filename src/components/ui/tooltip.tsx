      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            ...
            "border border-line-soft/40 bg-surface-panel-strong/95 backdrop-blur-md",
            "px-3 py-1.5 font-heading text-[10px] font-bold uppercase tracking-widest text-brand-core",
            "shadow-[0_0_15px_color-mix(in_srgb,var(--brand-core)_10%,transparent)]",
        ...
        >
          ...
          <TooltipPrimitive.Arrow
            className={cn(
              ...
              "bg-surface-panel-strong border-r border-b border-line-soft/40",
